# turbulatorMRFSTLSnappyHexMesh
This is a case to create  a MRF turbulator geometry using STL file and snappyHexMesh written based on OpenFOAM 6.


## Installation
It is working on foam-extend-4.1
```bash
git clone https://github.com/EhsanGLB/turbulatorMRFSTLSnappyHexMesh.git
```
